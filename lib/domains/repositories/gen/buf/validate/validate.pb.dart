...
import '../../google/protobuf/descriptor.pbenum.dart' as $110;
...
class MessageRules extends $pb.GeneratedMessage {
  ...
  ///  ```
  @$pb.TagNumber(4)
  $core.List<MessageOneofRule> get oneof => $_getList(1);
}
...
class FieldRules extends $pb.GeneratedMessage {
  ...
  ///  ```
  @$pb.TagNumber(23)
  $core.List<Rule> get cel => $_getList(21);
...
class DurationRules extends $pb.GeneratedMessage {
  factory DurationRules({
    $108.Duration? const_2,
    $108.Duration? lt,
    $108.Duration? lte,
    $108.Duration? gt,
    $108.Duration? gte,
    $core.Iterable<$108.Duration>? in_7,
    $core.Iterable<$108.Duration>? notIn,
    $core.Iterable<$108.Duration>? example,
  }) {
    final $result = create();
    if (const_2 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DurationRules', package: const $pb.PackageName(_omitMessageNames ? '' : 'buf.validate'), createEmptyInstance: create)
    ..oo(0, [3, 4])
    ..oo(1, [5, 6])
    ..aOM<$108.Duration>(2, _omitFieldNames ? '' : 'const', subBuilder: $108.Duration.create)
    ..aOM<$108.Duration>(3, _omitFieldNames ? '' : 'lt', subBuilder: $108.Duration.create)
    ..aOM<$108.Duration>(4, _omitFieldNames ? '' : 'lte', subBuilder: $108.Duration.create)
    ..aOM<$108.Duration>(5, _omitFieldNames ? '' : 'gt', subBuilder: $108.Duration.create)
    ..aOM<$108.Duration>(6, _omitFieldNames ? '' : 'gte', subBuilder: $108.Duration.create)
    ..pc<$108.Duration>(7, _omitFieldNames ? '' : 'in', $pb.PbFieldType.PM, subBuilder: $108.Duration.create)
    ..pc<$108.Duration>(8, _omitFieldNames ? '' : 'notIn', $pb.PbFieldType.PM, subBuilder: $108.Duration.create)
    ..pc<$108.Duration>(9, _omitFieldNames ? '' : 'example', $pb.PbFieldType.PM, subBuilder: $108.Duration.create)
    ..hasExtensions = true
  ;
  ...
  ///  ```
  @$pb.TagNumber(2)
  $108.Duration get const_2 => $_getN(0);
  @$pb.TagNumber(2)
  set const_2($108.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConst_2() => $_has(0);
  @$pb.TagNumber(2)
  void clearConst_2() => clearField(2);
  @$pb.TagNumber(2)
  $108.Duration ensureConst_2() => $_ensure(0);
  ...
  ///  ```
  @$pb.TagNumber(3)
  $108.Duration get lt => $_getN(1);
  @$pb.TagNumber(3)
  set lt($108.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasLt() => $_has(1);
  @$pb.TagNumber(3)
  void clearLt() => clearField(3);
  @$pb.TagNumber(3)
  $108.Duration ensureLt() => $_ensure(1);
  ...
  ///  ```
  @$pb.TagNumber(4)
  $108.Duration get lte => $_getN(2);
  @$pb.TagNumber(4)
  set lte($108.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLte() => $_has(2);
  @$pb.TagNumber(4)
  void clearLte() => clearField(4);
  @$pb.TagNumber(4)
  $108.Duration ensureLte() => $_ensure(2);
  ...
  ///  ```
  @$pb.TagNumber(5)
  $108.Duration get gt => $_getN(3);
  @$pb.TagNumber(5)
  set gt($108.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasGt() => $_has(3);
  @$pb.TagNumber(5)
  void clearGt() => clearField(5);
  @$pb.TagNumber(5)
  $108.Duration ensureGt() => $_ensure(3);
  ...
  ///  ```
  @$pb.TagNumber(6)
  $108.Duration get gte => $_getN(4);
  @$pb.TagNumber(6)
  set gte($108.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasGte() => $_has(4);
  @$pb.TagNumber(6)
  void clearGte() => clearField(6);
  @$pb.TagNumber(6)
  $108.Duration ensureGte() => $_ensure(4);
  ...
  ///  ```
  @$pb.TagNumber(7)
  $core.List<$108.Duration> get in_7 => $_getList(5);
  ...
  ///  ```
  @$pb.TagNumber(8)
  $core.List<$108.Duration> get notIn => $_getList(6);
  ...
  ///  ```
  @$pb.TagNumber(9)
  $core.List<$108.Duration> get example => $_getList(7);
}
...
class TimestampRules extends $pb.GeneratedMessage {
  factory TimestampRules({
    ...
    $core.bool? gtNow,
    $108.Duration? within,
    $core.Iterable<$109.Timestamp>? example,
  }) {
    final $result = create();
    if (const_2 != null) {
      $result.const_2 = const_2;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TimestampRules', package: const $pb.PackageName(_omitMessageNames ? '' : 'buf.validate'), createEmptyInstance: create)
    ..oo(0, [3, 4, 7])
    ..oo(1, [5, 6, 8])
    ..aOM<$109.Timestamp>(2, _omitFieldNames ? '' : 'const', subBuilder: $109.Timestamp.create)
    ..aOM<$109.Timestamp>(3, _omitFieldNames ? '' : 'lt', subBuilder: $109.Timestamp.create)
    ..aOM<$109.Timestamp>(4, _omitFieldNames ? '' : 'lte', subBuilder: $109.Timestamp.create)
    ..aOM<$109.Timestamp>(5, _omitFieldNames ? '' : 'gt', subBuilder: $109.Timestamp.create)
    ..aOM<$109.Timestamp>(6, _omitFieldNames ? '' : 'gte', subBuilder: $109.Timestamp.create)
    ..aOB(7, _omitFieldNames ? '' : 'ltNow')
    ..aOB(8, _omitFieldNames ? '' : 'gtNow')
    ..aOM<$108.Duration>(9, _omitFieldNames ? '' : 'within', subBuilder: $108.Duration.create)
    ..pc<$109.Timestamp>(10, _omitFieldNames ? '' : 'example', $pb.PbFieldType.PM, subBuilder: $109.Timestamp.create)
    ..hasExtensions = true
  ;
  ...
  ///  ```
  @$pb.TagNumber(2)
  $109.Timestamp get const_2 => $_getN(0);
  @$pb.TagNumber(2)
  set const_2($109.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConst_2() => $_has(0);
  @$pb.TagNumber(2)
  void clearConst_2() => clearField(2);
  @$pb.TagNumber(2)
  $109.Timestamp ensureConst_2() => $_ensure(0);
  ...
  ///  ```
  @$pb.TagNumber(3)
  $109.Timestamp get lt => $_getN(1);
  @$pb.TagNumber(3)
  set lt($109.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasLt() => $_has(1);
  @$pb.TagNumber(3)
  void clearLt() => clearField(3);
  @$pb.TagNumber(3)
  $109.Timestamp ensureLt() => $_ensure(1);
  ...
  ///  ```
  @$pb.TagNumber(4)
  $109.Timestamp get lte => $_getN(2);
  @$pb.TagNumber(4)
  set lte($109.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLte() => $_has(2);
  @$pb.TagNumber(4)
  void clearLte() => clearField(4);
  @$pb.TagNumber(4)
  $109.Timestamp ensureLte() => $_ensure(2);
  ...
  ///  ```
  @$pb.TagNumber(5)
  $109.Timestamp get gt => $_getN(3);
  @$pb.TagNumber(5)
  set gt($109.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasGt() => $_has(3);
  @$pb.TagNumber(5)
  void clearGt() => clearField(5);
  @$pb.TagNumber(5)
  $109.Timestamp ensureGt() => $_ensure(3);
  ...
  ///  ```
  @$pb.TagNumber(6)
  $109.Timestamp get gte => $_getN(4);
  @$pb.TagNumber(6)
  set gte($109.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasGte() => $_has(4);
  @$pb.TagNumber(6)
  void clearGte() => clearField(6);
  @$pb.TagNumber(6)
  $109.Timestamp ensureGte() => $_ensure(4);
  ...
  ///  ```
  @$pb.TagNumber(9)
  $108.Duration get within => $_getN(7);
  @$pb.TagNumber(9)
  set within($108.Duration v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasWithin() => $_has(7);
  @$pb.TagNumber(9)
  void clearWithin() => clearField(9);
  @$pb.TagNumber(9)
  $108.Duration ensureWithin() => $_ensure(7);
  ...
  ///  ```
  @$pb.TagNumber(10)
  $core.List<$109.Timestamp> get example => $_getList(8);
}
...
class FieldPathElement extends $pb.GeneratedMessage {
  factory FieldPathElement({
    ...
    $110.FieldDescriptorProto_Type? fieldType,
    $110.FieldDescriptorProto_Type? keyType,
    $110.FieldDescriptorProto_Type? valueType,
    $fixnum.Int64? index,
    $core.bool? boolKey,
    $fixnum.Int64? intKey,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FieldPathElement', package: const $pb.PackageName(_omitMessageNames ? '' : 'buf.validate'), createEmptyInstance: create)
    ...
    ..e<$110.FieldDescriptorProto_Type>(3, _omitFieldNames ? '' : 'fieldType', $pb.PbFieldType.OE, defaultOrMaker: $110.FieldDescriptorProto_Type.TYPE_DOUBLE, valueOf: $110.FieldDescriptorProto_Type.valueOf, enumValues: $110.FieldDescriptorProto_Type.values)
    ..e<$110.FieldDescriptorProto_Type>(4, _omitFieldNames ? '' : 'keyType', $pb.PbFieldType.OE, defaultOrMaker: $110.FieldDescriptorProto_Type.TYPE_DOUBLE, valueOf: $110.FieldDescriptorProto_Type.valueOf, enumValues: $110.FieldDescriptorProto_Type.values)
    ..e<$110.FieldDescriptorProto_Type>(5, _omitFieldNames ? '' : 'valueType', $pb.PbFieldType.OE, defaultOrMaker: $110.FieldDescriptorProto_Type.TYPE_DOUBLE, valueOf: $110.FieldDescriptorProto_Type.valueOf, enumValues: $110.FieldDescriptorProto_Type.values)
  ...
  @$pb.TagNumber(3)
  $110.FieldDescriptorProto_Type get fieldType => $_getN(2);
  @$pb.TagNumber(3)
  set fieldType($110.FieldDescriptorProto_Type v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $110.FieldDescriptorProto_Type get keyType => $_getN(3);
  @$pb.TagNumber(4)
  set keyType($110.FieldDescriptorProto_Type v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $110.FieldDescriptorProto_Type get valueType => $_getN(4);
  @$pb.TagNumber(5)
  set valueType($110.FieldDescriptorProto_Type v) { setField(5, v); }
  @$pb.TagNumber(5)
